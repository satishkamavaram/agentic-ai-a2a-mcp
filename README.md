...
1. 🔗 Single Server Connection - Can only connect to one MCP server at a time ![Important] **Under http folder in this report support for connecting to multiple MCP servers via mcp.json and support for http**
