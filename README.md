...
2. 🔒 Limited Privacy Protection - Only redacts email addresses (not other sensitive data). ![Important](https://img.shields.io/badge/IMPORTANT-red?style=for-the-badge) **Presidio library can be used with Spacy model to redact the PII (emails, phones, etc.) and write custom readaction module to redact custom values to protect intellectual propery.**
